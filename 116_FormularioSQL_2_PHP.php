...
<a href="115_FormularioSQL_2_PHP.php">Formulario para INSERTAR Datos</a>
    ...
    <form class="form1" action="116_FormularioSQL_2_PHP.php" method="post">
        <fieldset><legend>Datos Antiguos</legend>
        ...
        <fieldset><legend>Datos Nuevos</legend>
        NOMBRE: <input class="in1" type="text" name="nombre1" id="">  
        APELLIDO: <input class="in1" type="text" name="apellidos1" id="">
        <br>
        TELEFONO: <input type="tel" name="telefono1" id="" max="">
        DIRECCION: <input class="in1" type="text" name="direccion1" id="">  
        <br>
    ...
    <?php
        ...
        $sql = "UPDATE usuario set nombre = '$_POST[nombre1]' where nombre = '$_POST[nombre]'";
        mysqli_query($cn,$sql);

        $sql = "UPDATE usuario set apellidos = '$_POST[apellidos1]' where apellidos = '$_POST[apellidos]'";
        mysqli_query($cn,$sql);

        $sql = "UPDATE usuario set telefono = '$_POST[telefono1]' where telefono = '$_POST[telefono]'";
        mysqli_query($cn,$sql);

        $sql = "UPDATE usuario set direccion = '$_POST[direccion1]' where direccion = '$_POST[direccion]'";
        mysqli_query($cn,$sql);
        ...
        header("refresh:0 url=116_FormularioSQL_2_PHP.php");
